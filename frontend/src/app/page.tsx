...
export default function Home() {
  ...
  >([]);
  // "light" = putih (hero+about), "dark" = liquid glass (text-animation+)
  ...
  useEffect(() => {
    ...
    // Scroll listener — deteksi posisi relatif ke text-animation section
    const handleScroll = () => {
    ...
    <>
      <div className="relative flex min-h-screen flex-col justify-between bg-[#004e8a] text-white font-sans overflow-hidden">
        ...
        <header className="fixed top-0 z-50 w-full px-4 pt-4 md:px-8">
          ...
          >
            ...
            <Link href="/" className="relative z-10 flex items-center gap-2 group shrink-0">
              ...
              <span className={["text-xl font-bold tracking-tight transition-colors duration-300",
                navTheme === "light" ? "text-[#00172e]" : "text-white drop-shadow-sm"
              ].join(" ")}>
            ...
            {/* ── Desktop Nav ── */}
            <nav className={["relative z-10 hidden items-center gap-7 text-sm font-medium md:flex transition-colors duration-300",
              navTheme === "light" ? "text-slate-600" : "text-slate-200"
            ].join(" ")}>
              {[
                ...
                <Link
                  ...
                  className={["flex items-center gap-1.5 transition-all hover:scale-105",
                    navTheme === "light" ? "hover:text-[#008be3]" : "hover:text-cyan-300"
                  ].join(" ")}
                >
                  {item.icon}
                  {item.label}
            ...
            {/* ── Mobile Hamburger ── */}
            <button
              className={["relative z-10 flex md:hidden items-center justify-center w-9 h-9 rounded-full transition-colors",
                navTheme === "light"
          ...
          <div className={[
            ...
            mobileOpen ? "opacity-100 scale-y-100 max-h-[400px]" : "opacity-0 scale-y-95 max-h-0 pointer-events-none"
          ].join(" ")}>
            <div className={[
              ...
              <div className="border-t mt-2 pt-3 flex flex-col gap-2 border-slate-200/20">
                <Link
                  href="/auth/login"
                  onClick={() => setMobileOpen(false)}
                  className={["w-full text-center rounded-xl px-4 py-2.5 text-sm font-semibold border transition-colors",
                    navTheme === "light"
        ...
        <div
          className="relative z-20 -mb-1 pointer-events-none"
          style={{ lineHeight: 0 }}
        >
          <svg
            viewBox="0 0 1440 90"
          ...
          >
            <path
              d="M0,45 C240,85 480,10 720,50 C960,88 1200,15 1440,45 L1440,90 L0,90 Z"
              fill="#ffffff"
            />
          </svg>
        </div>
      ...
      <section className="relative bg-white text-[#00172e] overflow-hidden">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-x-8 gap-y-10 mb-20">
            {[
              ...
              >
                ...
                <div>
                  <h4 className="font-bold text-[#00172e] text-sm mb-1">
                    {item.title}
                  </h4>
        ...
        >
          ...
          >
            <path
              d="M0,45 C360,5 1080,85 1440,45 L1440,90 L0,90 Z"
              fill="#00172e"
            />
          </svg>
        </div>
      ...
      {/* ─────────────────────────────────────────── */}
      <section id="text-animation-section" className="bg-gradient-to-b from-[#00172e] via-[#001529] to-[#00172e] text-white overflow-hidden">
