...
import { ChevronRight, ChevronLeft, Star, Clock, Users, Trash2 } from "lucide-react";
...
export default function PelajarCoursePage() {
              ...
              <div className="p-4 flex flex-col gap-3 flex-1">
                ...
                <div className="mt-auto pt-2 border-t border-slate-100 flex items-center justify-between">
                  ...
                  <div className="flex items-center gap-2">
                    {course.enrolled && (
                      <button onClick={(e) => e.preventDefault()} className="text-red-400 hover:text-red-500 transition-colors p-1">
