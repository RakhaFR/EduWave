...
export default function PembimbingCourseLessonsPage() {
              ...
              <div className="space-y-4">
                ...
                {formData.type !== "quiz" && (
                  <>
                    ...
                    <div className="flex items-center gap-2">
                      <input type="checkbox" id="is_preview_pembimbing" checked={formData.is_preview} onChange={(e) => setFormData({ ...formData, is_preview: e.target.checked })} className="w-4 h-4 cursor-pointer" />
                      <label htmlFor="is_preview_pembimbing" className="text-sm font-semibold text-slate-700 cursor-pointer">Preview (bisa diakses tanpa enroll)</label>
                    </div>
                  </>
                )}
              </div>
