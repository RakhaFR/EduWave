        ...
        <div className="relative">
          ...
          >
            ...
            <div className="hidden lg:flex flex-col text-left">
              <span className="text-xs font-bold leading-tight">Pembimbing</span>
              <span className="text-[9px] text-white/70 leading-none">Pengajar EduWave</span>
            </div>
          ...
          {profileDropdownOpen && (
            <div className="absolute right-0 top-full mt-2 w-48 bg-white rounded-2xl shadow-2xl border border-slate-100 py-2 z-50 overflow-hidden text-sm">
              <div className="px-4 py-2 border-b border-slate-100 lg:hidden">
                <p className="font-bold text-slate-700">Pembimbing</p>
                <p className="text-[10px] text-slate-400">Pengajar EduWave</p>
              </div>
              <button
                onClick={() => {
