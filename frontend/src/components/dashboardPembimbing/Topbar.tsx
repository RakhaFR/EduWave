...
export default function Topbar({
  ...
  const notifications = [
    {
      title: "Kursus Bimbingan",
      text: "Kelola modul, upload materi, dan tinjau kemajuan siswa bimbingan.",
      href: "/pembimbing/course",
      time: "Hari ini",
    },
    {
      title: "Manajemen Ujian",
      text: "Buat atau edit butir soal ujian & kunci jawaban untuk kursus Anda.",
      href: "/pembimbing/exam",
      time: "Tersedia",
    },
    {
      title: "Profil & Informasi",
      text: "Perbarui bio, spesialisasi keahlian, dan foto avatar pembimbing.",
          ...
          {notificationsOpen && (
            <div className="absolute right-0 top-full mt-2 z-50 w-72 sm:w-80 rounded-2xl bg-white p-4 shadow-xl text-slate-700 border border-slate-100 divide-y divide-slate-100">
              <div className="flex items-center justify-between pb-2">
                <p className="text-sm font-bold text-[#00172e]">Notifikasi Pembimbing</p>
