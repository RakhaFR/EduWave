...
export default function AdminProfileComponent() {
  ...
  return (
    <main className="px-4 md:px-8 py-4 md:py-6 max-w-lg mx-auto">
      <h1 className="text-xl md:text-2xl font-extrabold mb-4 text-center text-white">Profil Admin EduWave</h1>
        ...
        {loading && !user ? (
          ...
          <>
            ...
            <div className="text-center">
              <div className="w-24 h-24 mx-auto mb-3 bg-gradient-to-tr from-[#1e293b] to-[#0073e6] text-white text-3xl font-extrabold rounded-full flex items-center justify-center shadow-lg border-4 border-white overflow-hidden">
            ...
            <div className="bg-slate-50 rounded-2xl p-4 space-y-3 text-xs border border-slate-100">
              <div className="flex items-center gap-3">
                ...
                <div className="overflow-hidden">
                  <p className="text-slate-400 font-medium">Email Admin</p>
              ...
              <div className="flex items-center gap-3">
                ...
                <div>
                  <p className="text-slate-400 font-medium">Bio Admin</p>
                  <p className="font-semibold text-slate-700">{user?.bio || "Administrator Sistem EduWave."}</p>
                </div>
              </div>
            </div>
          </>
