      ...
      <div className="flex-1 flex flex-col gap-6 overflow-y-auto pr-1">
        ...
        <div>
          ...
          <nav className="flex flex-col gap-1">
            ...
            <Link
              href="/admin/profile"
              className={`flex items-center gap-3 px-3 py-2.5 rounded-xl text-sm font-medium transition-all text-left w-full cursor-pointer ${isActive("/admin/profile") ? "bg-[#e6f3ff] text-[#0073e6] font-semibold" : "text-slate-500 hover:bg-slate-50 hover:text-[#0073e6]"}`}
            >
